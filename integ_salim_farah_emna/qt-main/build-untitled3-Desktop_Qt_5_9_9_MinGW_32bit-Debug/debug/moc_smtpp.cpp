...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Smtpp_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Smtpp_t qt_meta_stringdata_Smtpp = {
    {
QT_MOC_LITERAL(0, 0, 5), // "Smtpp"
...
void Smtpp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Smtpp::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Smtpp::status)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Smtpp::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Smtpp.data,
      qt_meta_data_Smtpp,  qt_static_metacall, nullptr, nullptr}
};
